                                                ...
                                                if (showCircle && showShapes) {
                                                    ...
                                                    val circlePath = Path().apply {
                                                        ...
                                                        for (angle in 0..360 step 10) { // Draw small line segments to approximate the circle
                                                            val x = circleCenterX + radius * cos(
                                                                Math.toRadians(angle.toDouble())
                                                            ).toFloat()
                                                            val y = circleCenterY + radius * sin(
                                                                Math.toRadians(angle.toDouble())
                                                            ).toFloat()
                                                            lineTo(x, y)
                                                        }
                                            ...
                                            if (tapX == 0f && tapY == 0f) {
                                                ...
                                                if (showShapes) {
                                                    ...
                                                    val height = Math.sqrt(
                                                        Math.pow(
                                                            (vertex2X - vertex1X).toDouble(),
                                                            2.0
                                                        ) + Math.pow(
                                                            (vertex2Y - vertex1Y).toDouble(),
                                                            2.0
                                                        )
                                                    ) * Math.sqrt(3.0) / 2
                                                    val halfBase = Math.sqrt(
                                                        Math.pow(
                                                            (vertex2X - vertex1X).toDouble(),
                                                            2.0
                                                        ) + Math.pow(
